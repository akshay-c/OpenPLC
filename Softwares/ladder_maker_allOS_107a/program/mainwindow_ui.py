...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.infoButton.setObjectName(_fromUtf8("burnButton"))
        ...
        self.actionCompile_Hex.setObjectName(_fromUtf8(""))####################################
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.infoButton.setToolTip(_translate("MainWindow", "<html><head/><body><p>Create hex file in your project directory</p></body></html>", None))
        self.infoButton.setWhatsThis(_translate("MainWindow", "<html><head/><body><p>This buton starts the following: </p><p>- creation of C code.  </p><p>- compiling of that cod with GCC</p><p>- save the resultant hex in save directory</p></body></html>", None))
        self.infoButton.setText(_translate("MainWindow", "compile", None))
        self.burnButton.setToolTip(_translate("MainWindow", "<html><head/><body><p>Create hex file and upload it to the Hardware</p></body></html>", None))
        self.burnButton.setWhatsThis(_translate("MainWindow", "<html><head/><body><p>This buton starts the following: </p><p>- creation of C code.  </p><p>- compiling of that cod with GCC</p><p>- uploading of the resulting hex file to the hardware via USB</p></body></html>", None))
        self.burnButton.setText(_translate("MainWindow", "burn", None))
        ...
        self.actionOpenPLC.setText(_translate("MainWindow","OpenPLC", None))
